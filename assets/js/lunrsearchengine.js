...
function lunr_search(term) {
    ...
    if(term) {
        ...
        if(results.length>0){
            ...
            document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML = "<li class='lunrsearchresult'>Nenhum resultado foi encontrado. Feche e tente uma pesquisa diferente!</li>";
        }
    }
    return false;
}
